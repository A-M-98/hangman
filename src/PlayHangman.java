...
public class PlayHangman {
    ...
    public static void StarGame() {
        //This is where all the classes will connect together and the code will be run.
        //Starting message
        ...
        while (unfinished){
            ...
            System.out.println(TEXT_CYAN + "Checking if your guess is in the word");
