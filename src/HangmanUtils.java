...
//This class is for the functionality of the game.
...
public class HangmanUtils {
    ...
    static {
        ...
        listOfWords.add("science");
        listOfWords.add("rugby");
        listOfWords.add("interesting");
        listOfWords.add("investigate");
        listOfWords.add("propeller");
